...
public class SQLDroidPreparedStatement implements PreparedStatement {
    ...
    public SQLDroidPreparedStatement(String sql, SQLDroidConnection sqldroid) throws SQLException {
    ...
    private SQLiteStatement getStatement() {
        if (this.stmt == null) {
            this.stmt = this.db.sqliteDatabase.compileStatement(sql);
        }
        return this.stmt;
    }
    ...
    public boolean execute() throws SQLException {
        ...
        if (isSelect) {
            ...
            db.execStatement(this.getStatement(), makeArgListQueryObject());
        }
        return isSelect;
    }
    ...
    public int[] executeBatch() throws SQLException {
        ...
        for (int i = 0; i < lBatch.size(); i++) {
            ...
            db.execStatement(this.getStatement(), lBatch.get(i).toArray());
